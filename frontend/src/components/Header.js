...
import { AppBar, Toolbar, Tab, Tabs, ImageList, ImageListItem, IconButton } from '@mui/material';
    ...
    <div>
      <AppBar sx={{ backgroundColor: 'green' }} position='sticky'>
        <Toolbar>
          ...
          {/* Add the AccountCircleRoundedIcon to the right of the header with increased size and padding */}
          <IconButton color="inherit" component={NavLink} to='/account' sx={{ width: 60, height: 60, marginleft: '10px' }}>
